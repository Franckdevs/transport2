            ...
            Vous allez Modifier les informations de ce membre du personnel {{ $personnel->nom }} {{ $personnel->prenom }}.
                            ...
                            <div class="card-body p-4">
                                <form action="{{ route('personnel.update', $personnel->id) }}" method="POST" enctype="multipart/form-data" id="user-form">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="telephone" id="telephone" class="form-control" 
                                                           value="{{ old('telephone', $personnel->telephone) }}" placeholder="0123456789" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="email" name="email" id="email" class="form-control" 
                                                       value="{{ old('email', $personnel->email) }}" placeholder="exemple@domaine.com" 
                                    ...
                                    <div class="mb-4">
                                        {{-- <h5 class="mb-3 text-primary">
                                            <i class="fa fa-id-card me-2"></i>Profil utilisateur
                                        </h5> --}}
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div id="photo-preview-container" class="mb-3 text-center">
                                                    ...
                                                    @if(!empty($personnel->photo))
                                                        <div class="mb-3">
                                                            <p class="text-muted mb-2"><small>Photo actuelle :</small></p>
                                                            <img src="{{ asset($personnel->photo) }}" 
                                                                 alt="Photo actuelle"
                                                                 class="img-thumbnail rounded-circle current-photo"
                                                                 style="width: 150px; height: 150px; object-fit: cover;">
                                                        </div>
                                                        <p class="text-muted mb-3"><small>Nouvelle photo (optionnelle) :</small></p>
                                                    @endif
                                                    ...
                                                    <img id="photo-preview" 
                                                         ...
                                                         style="width: 150px; height: 150px; object-fit: cover;">
                                                    <div id="photo-placeholder" class="text-muted py-3 {{ !empty($personnel->photo) ? 'd-none' : '' }}">
                                                        <i class="fa fa-user-circle fa-3x mb-2"></i>
                                                        <p class="mb-0">Aucune nouvelle photo sélectionnée</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="role_utilisateurs_id" id="role_utilisateurs_id" class="form-select" required>
                                                    ...
                                                    @foreach($rolepersonnels as $role)
                                                        <option value="{{ $role->id }}" 
                                                            ...
                                                            {{ old('role_utilisateurs_id', $personnel->role_utilisateurs_id) == $role->id ? 'selected' : '' }}>
                                                            {{ $role->nom_role }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <div id="role-description" class="role-description mt-3">
                                                    @php
                                                        $selectedRole = $rolepersonnels->firstWhere('id', old('role_utilisateurs_id', $personnel->role_utilisateurs_id));
                                                    @endphp
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            if (removePhotoCheckbox) {
                removePhotoCheckbox.addEventListener('change', function() {
                    if (this.checked) {
                        // Optionnel : masquer la prévisualisation si on veut supprimer
                        photoPreview.classList.add('d-none');
                        photoPlaceholder.classList.remove('d-none');
                    }
                });
