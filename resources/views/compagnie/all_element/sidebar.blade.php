        ...
        <div class="main-menu flex-grow-1">
            <ul class="menu-list">
                ...
                <!-- Tableau de bord -->
@if(Auth::user()->can('voir-tableau-de-bord-compagnie') || Auth::user()->can('tout-les-permissions'))                <li class="{{ request()->routeIs('dashboardcompagnie_name') ? 'active' : '' }}">
                ...
                <li class="{{ request()->routeIs('compagnie.bus') ? 'active' : '' }}">
                    <a class="m-link" href="{{ route('compagnie.bus') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M4 0a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H4zm0 1h8a1 1 0 0 1 1 1v9H3V2a1 1 0 0 1 1-1zm1 11a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm6 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                        </svg>
                ...
                <li class="{{ request()->routeIs('chauffeur.*') ? 'active' : '' }}">
                    <a class="m-link" href="{{ route('chauffeur.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M8 0a3 3 0 0 1 3 3v1a3 3 0 1 1-6 0V3a3 3 0 0 1 3-3zm4 14c0 1.105-.895 2-2 2H6a2 2 0 0 1-2-2v-1c0-1.104.895-2 2-2h4c1.105 0 2 .896 2 2v1z"/>
                        </svg>
                ...
                <li class="{{ request()->routeIs('itineraire.*') ? 'active' : '' }}">
                    <a class="m-link" href="{{ route('itineraire.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M8 0a8 8 0 1 0 8 8A8 8 0 0 0 8 0zm3.5 9.5a.5.5 0 0 1-.5.5H5a.5.5 0 0 1-.5-.5V6.707L6.354 8.56a.5.5 0 0 0 .707 0l2.793-2.793V9.5z"/>
                            <path fill-rule="evenodd" d="M0 8a8 8 0 1 0 8 8 8 8 0 0 0-8-8zm1 0h6v5H1V8zm7 5h6V8H8v5z"/>
                        </svg>
                ...
                <li class="{{ request()->routeIs('voyage.*') ? 'active' : '' }}">
                    <a class="m-link" href="{{ route('voyage.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M1 2a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H1zM1 4h14v8H1V4z"/>
            ...
            <style>/* état normal */
                ...
                .menu-list > li.active > a {
                    color: #91E3AF !important; /* ta couleur verte */
                    font-weight: bold;
                }
