  <div class="sidebar p-2 py-md-3 @@cardClass">
      ...
      <!-- sidebar: menu list -->
        ...
        {{-- @canany(['tout-les-permissions', 'voir-tableau-de-bord-compagnie']) --}}

        {{-- @endcan --}}

          <li>
            {{-- <a class="m-link active" href="{{ route('liste.bus') }}">
          ...
          {{-- <li class="collapsed">
            ...
            <path d="M15 8a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1V2.64c0-1.188-.845-2.232-2.064-2.372A44 44 0 0 0 8 0C5.9 0 4.208.136 3.064.268 1.845.408 1 1.452 1 2.64V4a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1v3.5c0 .818.393 1.544 1 2v2a.5.5 0 0 0 .5.5h2a.5.5 0 0 0 .5-.5V14h6v1.5a.5.5 0 0 0 .5.5h2a.5.5 0 0 0 .5-.5v-2c.607-.456 1-1.182 1-2zM8 1c2.056 0 3.71.134 4.822.261.676.078 1.178.66 1.178 1.379v8.86a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 11.5V2.64c0-.72.502-1.301 1.178-1.379A43 43 0 0 1 8 1"/>
              ...
              <span class="ms-2">GARE</span>
              <span class="arrow fa fa-angle-right ms-auto text-end"></span>
            </a>
            <!-- Menu: Sub menu ul -->
            <ul class="sub-menu collapse" id="menu-Applications">
              <li><a class="ms-link" href="{{ route('liste.bus') }}">BUS / CARS</a></li>
            </ul>

             <ul class="sub-menu collapse" id="menu-Applications">
              <li><a class="ms-link" href="{{ route('gares.index') }}">GARE</a></li>
            </ul>
           ...
           <li>
            <a class="m-link" href="{{ route('gares.index.2') }}">
                {{-- @if(Route::has('gares.index') && Auth::check())
                    <a class="class=m-link" href="{{ route('gares.index') }}">
                @endif --}}
