...
@include('compagnie.all_element.sidebar')
  ...
  <div class="card">
    <div class="card-body">
      <h5 class="mb-4">Cree un nouveau bus</h5>
...
<form action="{{ route('bus.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="text" name="nom_bus" id="nom_bus" class="form-control" value="{{ old('nom_bus') }}">
        </div>

        <div class="col-md-6 mb-3">
            <label for="marque_bus" class="form-label">Marque du bus</label>
            <input type="text" name="marque_bus" id="marque_bus" class="form-control" value="{{ old('marque_bus') }}">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="text" name="modele_bus" id="modele_bus" class="form-control" value="{{ old('modele_bus') }}">
        </div>

        <div class="col-md-6 mb-3">
            <label for="immatriculation_bus" class="form-label">Immatriculation du bus</label>
            <input type="text" name="immatriculation_bus" id="immatriculation_bus" class="form-control" value="{{ old('immatriculation_bus') }}">
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" name="description_bus" id="description_bus" class="form-control" value="{{ old('description_bus') }}">
        </div>
    </div>
