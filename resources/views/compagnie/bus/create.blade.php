                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="immatriculation_bus" id="immatriculation_bus"
                                            class="form-control" value="{{ old('immatriculation_bus') }}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="description_bus" id="description_bus"
                                            class="form-control" value="{{ old('description_bus') }}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="localisation_bus" id="localisation_bus"
                                            class="form-control" value="{{ old('localisation_bus') }}">
                                    </div>
                                </div>
