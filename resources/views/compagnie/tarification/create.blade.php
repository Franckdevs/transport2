...
<body class="layout-1" data-luno="theme-blue">
                    ...
                    <div class="col-12">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form id="tarificationForm" action="{{ route('tarification.store') }}" method="POST" novalidate>
                                    @csrf
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="submit" id="submitBtn" class="btn btn-warning text-white d-flex align-items-center">
                                            ...
                                            <span id="submitText" class="me-2">Enregistrer</span>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Gestion du chargement du bouton de soumission
            $('#tarificationForm').on('submit', function() {
                $('#submitBtn').prop('disabled', true);
            ...
            $('button[type="reset"]').on('click', function() {
                $('#tarificationForm').trigger('reset');
